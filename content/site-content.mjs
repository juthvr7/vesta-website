export const locales = {
  en: {
    ...
    hero: {
      ...
      lineTwo: "Every world.",
      lede:
        "Vesta unifies terrain, geometry, imagery, placement, and host engines in one typed, deterministic spatial computation system.",
      primaryCta: "See the system",
      secondaryCta: "View the current build",
      visualLabel: "Conceptual system visualization",
      videoPause: "Pause motion film",
      videoPlay: "Play motion film",
      signals: [
  ...
  zh: {
    ...
    hero: {
      ...
      lineTwo: "构成万千世界。",
      lede:
        "Vesta 将地形、几何、影像、放置与宿主引擎统一进一套类型化、确定性的空间计算系统。",
      primaryCta: "了解系统",
      secondaryCta: "查看当前构建",
      visualLabel: "系统概念视觉",
      videoPause: "暂停动态短片",
